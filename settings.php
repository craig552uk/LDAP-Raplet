...
OAuth tokens are generated by appending a salt string to the username
then hashing with SHA1 and appending an identifier string to the head

$token = $oauth_params['head_string'] . sha1($oauth_params['salt_string'] . $username);
...
$oauth_params['head_string']        = "RAPORTIVE";
